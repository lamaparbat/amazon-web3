...
const Navbar = () => {
 return (
  <div className='flex justify-between py-2 pl-5 pe-2 bg-dark text-light overflow-hidden'>
   <AiOutlineAmazon className='text-[45px] text-light ml-5 me-5 cursor-pointer' />
   <SearchableDropdown />
   <div className='flex'>
    <CountrySelect />
