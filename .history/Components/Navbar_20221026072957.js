...
const Navbar = () => {
 return (
  <div className='flex justify-between h-fit py-2 pl-5 pe-2 bg-dark text-light'>
   <div className='bg-danger w-50 flex justify-center'>
    <GrAmazon className='text-4xl position-absolute text-light cursor-pointer' />
   </div>
   <div className='flex mx-4 w-[400px] items-center cursor-pointer'>
