...
const Navbar = () => {
 return (
  <div className='flex justify-between h-fit py-1 pl-5 pe-2 bg-dark text-light'>
   <AiOutlineAmazon className='text-5xl bg-danger text-light ml-5 me-5 cursor-pointer' />
   <SearchableDropdown />
